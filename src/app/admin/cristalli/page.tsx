...
import { getCristalli, ItemColore } from "@/lib/configuratore";
...
export default function AdminCristalli() {
    ...
    <div>
      ...
      <div className={styles.toolbar}>
        <div className={styles.toolbarLeft}>
          ...
          <span className={styles.count}>
            {loading ? "..." : `${filtrati.length} cristalli`}
          </span>
        </div>
      ...
      {loading ? (
        ...
        <div className={styles.grid}>
          ...
          {filtrati.map((item) => (
            <div key={item.id} className={styles.gridRow} style={{ gridTemplateColumns: COLONNE }} onClick={() => router.push(`/admin/cristalli/${item.id}`)}>
