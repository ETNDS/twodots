    ...
    <>
      ...
      <main className={styles.main}>
        ...
        <div className={styles.alternative}>
          ...
          <a className={styles.altLink} href={SOCIAL.instagram} target="_blank" rel="noopener noreferrer">@twodotsdesign</a>
          <p className={styles.altText} style={{ marginTop: "16px" }}>Seguici su Facebook</p>
          <a className={styles.altLink} href={SOCIAL.facebook} target="_blank" rel="noopener noreferrer">twodotsdesign</a>
        </div>
      </main>
      <Footer />
    </>
